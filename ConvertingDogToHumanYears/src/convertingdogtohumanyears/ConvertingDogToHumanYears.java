...
package convertingdogtohumanyears;

/**
 *
 * @author marvintailor Cmpsci 
 */
...
public abstract class ConvertingDogToHumanYears extends JFrame implements ChangeListener{
...
/* Constructor creates GUI components and adds GUI components
   ...
   public void stateChanged(ChangeEvent event) {
    ...
    public static void main(String[] args) {
      ...
      ConvertingDogToHumanYears myFrame = new ConvertingDogToHumanYears() {};
